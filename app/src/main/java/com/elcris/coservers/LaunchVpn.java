...
public class LaunchVpn extends AppCompatActivity implements DialogInterface.OnCancelListener  {
	...
	public static final String EXTRA_HIDELOG = "com.elcris.coservers.showNoLogWindow";
	...
	private void showLogWindow() {
        Intent updateView = new Intent("com.elcris.coservers:openLogs");
	...
	public void metodomrx() {
		...
		//TextView todometodo = findViewById(R.id.todometodo);
		//todometodo.setText("host:port:user:pass");
		EditText textoplano = findViewById(R.id.inputall);

		//TextView host1 = findViewById(R.id.host1);
		//TextView port1 = findViewById(R.id.port1);
		...
		SharedPreferences.Editor edit = mConfig.getPrefsPrivate().edit();
		String mString = ((EditText) findViewById(R.id.inputall)).getText().toString();




		//if(!textoplano.getText().toString().isEmpty()){  //original
		if(!textoplano.getText().toString().isEmpty()){

			String[] parts = mString.split(":|:\\s|@\\s|@|\\s");
