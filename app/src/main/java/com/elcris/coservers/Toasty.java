...
public class Toasty {
    ...
    public static Toast warning(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, R.drawable.equis1),
                ToastyUtils.getColor(context, R.color.warningColor), ToastyUtils.getColor(context, R.color.blanco),
    ...
    public static Toast warning(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.equis1),
                ToastyUtils.getColor(context, R.color.warningColor), ToastyUtils.getColor(context, R.color.blanco),
                duration, withIcon, true);
    }
    ...
    public static Toast info(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, R.drawable.back_icon),
                ToastyUtils.getColor(context, R.color.infoColor), ToastyUtils.getColor(context, R.color.blanco),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast info(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.back_icon),
                ToastyUtils.getColor(context, R.color.infoColor), ToastyUtils.getColor(context, R.color.blanco),
                duration, withIcon, true);
    }
    ...
    public static Toast success(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, R.drawable.hotspot),
                ToastyUtils.getColor(context, R.color.successColor), ToastyUtils.getColor(context, R.color.blanco),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast success(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.hotspot),
                ToastyUtils.getColor(context, R.color.successColor), ToastyUtils.getColor(context, R.color.blanco),
                duration, withIcon, true);
    }
    ...
    public static Toast error(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, R.drawable.ic_plane),
                ToastyUtils.getColor(context, R.color.errorColor), ToastyUtils.getColor(context, R.color.blanco),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast error(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.ic_plane),
                ToastyUtils.getColor(context, R.color.errorColor), ToastyUtils.getColor(context, R.color.blanco),
                duration, withIcon, true);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
        ...
        return custom(context, context.getString(message), icon, -1, ToastyUtils.getColor(context, R.color.blanco),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                               int duration, boolean withIcon) {
        return custom(context, message, icon, -1, ToastyUtils.getColor(context, R.color.blanco),
                duration, withIcon, false);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, @DrawableRes int iconRes,
        ...
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, iconRes),
                ToastyUtils.getColor(context, tintColorRes), ToastyUtils.getColor(context, R.color.blanco),
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
        ...
        return custom(context, context.getString(message), icon, ToastyUtils.getColor(context, tintColorRes),
                ToastyUtils.getColor(context, R.color.blanco), duration, withIcon, shouldTint);
    }
    ...
    private static Toast withLightTheme(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                                        int duration, boolean withIcon) {
        return custom(context, message, icon, ToastyUtils.getColor(context, R.color.blanco),
    ...
    private static Toast withDarkTheme(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        return custom(context, message, icon, ToastyUtils.getColor(context, R.color.normalColor),
                ToastyUtils.getColor(context, R.color.blanco), duration, withIcon, true);
    }

    public static class Config {
        private Typeface typeface = com.elcris.coservers.Toasty.currentTypeface;
        private int textSize = com.elcris.coservers.Toasty.textSize;

        private boolean tintIcon = com.elcris.coservers.Toasty.tintIcon;
        private boolean allowQueue = true;
        private int toastGravity = com.elcris.coservers.Toasty.toastGravity;
        private int xOffset = com.elcris.coservers.Toasty.xOffset;
        private int yOffset = com.elcris.coservers.Toasty.yOffset;
        ...
        @CheckResult
        public static com.elcris.coservers.Toasty.Config getInstance() {
            return new com.elcris.coservers.Toasty.Config();
        }

        public static void reset() {
            com.elcris.coservers.Toasty.currentTypeface = LOADED_TOAST_TYPEFACE;
            com.elcris.coservers.Toasty.textSize = 16;
            com.elcris.coservers.Toasty.tintIcon = true;
            com.elcris.coservers.Toasty.allowQueue = true;
            com.elcris.coservers.Toasty.toastGravity = -1;
            com.elcris.coservers.Toasty.xOffset = -1;
            com.elcris.coservers.Toasty.yOffset = -1;
            com.elcris.coservers.Toasty.supportDarkTheme = true;
            com.elcris.coservers.Toasty.isRTL = false;
        }

        @CheckResult
        public com.elcris.coservers.Toasty.Config setToastTypeface(@NonNull Typeface typeface) {
            this.typeface = typeface;
            return this;
        }

        @CheckResult
        public com.elcris.coservers.Toasty.Config setTextSize(int sizeInSp) {
            this.textSize = sizeInSp;
            return this;
        }

        @CheckResult
        public com.elcris.coservers.Toasty.Config tintIcon(boolean tintIcon) {
            this.tintIcon = tintIcon;
            return this;
        }

        @CheckResult
        public com.elcris.coservers.Toasty.Config allowQueue(boolean allowQueue) {
            this.allowQueue = allowQueue;
            return this;
        }

        @CheckResult
        public com.elcris.coservers.Toasty.Config setGravity(int gravity, int xOffset, int yOffset) {
        ...
        @CheckResult
        public com.elcris.coservers.Toasty.Config setGravity(int gravity) {
            this.toastGravity = gravity;
            return this;
        }

        @CheckResult
        public com.elcris.coservers.Toasty.Config supportDarkTheme(boolean supportDarkTheme) {
            this.supportDarkTheme = supportDarkTheme;
            return this;
        }

        public com.elcris.coservers.Toasty.Config setRTL(boolean isRTL) {
            this.isRTL = isRTL;
            return this;
        }

        public void apply() {
            com.elcris.coservers.Toasty.currentTypeface = typeface;
            com.elcris.coservers.Toasty.textSize = textSize;
            com.elcris.coservers.Toasty.tintIcon = tintIcon;
            com.elcris.coservers.Toasty.allowQueue = allowQueue;
            com.elcris.coservers.Toasty.toastGravity = toastGravity;
            com.elcris.coservers.Toasty.xOffset = xOffset;
            com.elcris.coservers.Toasty.yOffset = yOffset;
            com.elcris.coservers.Toasty.supportDarkTheme = supportDarkTheme;
            com.elcris.coservers.Toasty.isRTL = isRTL;
        }
    }
}
