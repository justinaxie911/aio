package com.elcris.coservers.tunnel.vpn;

/*
 * Copyright (c) 2016, Psiphon Inc.ffe400
 * All rights reserved.
 *
...
public class TunnelVpnManager implements Tunnel.HostService
{
	...
	{
		return getContext().getString(R.string.crisname);
	}
	...
	{   
        Settings mConfig = new Settings(getContext());
		SkStatus.logInfo("UDP: " + "<font color=\"#ffffff\">" + mConfig.getVpnUdpResolver() +"</font>");
		SkStatus.logInfo("DNS Primario: " + "<font color=\"#ffffff\">" + mConfig.getVpnDnsResolver1() +"</font>");
		SkStatus.logInfo("DNS Secundario: " + "<font color=\"#ffffff\">" + mConfig.getVpnDnsResolver2() +"</font>");
		SkStatus.logInfo("<strong><font color=\"#ffe400\">Connection exitosa</font></strong>");
