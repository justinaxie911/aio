 ...
 * Original file: /storage/emulated/0/Download/SDK TUNNEL SBR TIME/SDK TUNNEL SBR TIME/app/src/main/java/me/dawson/proxyserver/ui/IProxyControl.aidl
 */
...
public interface IProxyControl extends android.os.IInterface
{
    ...
    {
        private static final String DESCRIPTOR = "clay.wifi.ui.IProxyControl";
        ...
        /**
         * Cast an IBinder object into an clay.wifi.ui.IProxyControl interface,
        ...
        public static me.dawson.proxyserver.ui.IProxyControl asInterface(android.os.IBinder obj)
        {
            ...
            return (IProxyControl) new Proxy(obj);
        }
